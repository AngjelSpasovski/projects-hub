...
export const PROJECTS: PortfolioProject[] = [
  ...
  },
  {
    order: 250,
    id: 'math-4-kids',
    titleKey: 'PROJECTS.MATH_4_KIDS.TITLE',
    summaryKey: 'PROJECTS.MATH_4_KIDS.SUMMARY',
    categoryKey: 'CATEGORIES.GAMES',
    tags: ['Angular', 'TypeScript', 'Signals', 'Forms'],
    status: 'ready',
    image: 'assets/project-covers/math-4-kids.svg',
    route: '/admin/projects/math-4-kids',
    updatedAt: '2026-07-13',
    createdAt: '2026-07-13',
    difficulty: 'beginner',
    layout: 'wide',
    repositoryUrl: `${REPOSITORY_BASE_URL}/math-4-kids`,
    demoUrl: null
  },
  {
    order: 260,
    id: 'music-player',
    titleKey: 'PROJECTS.MUSIC_PLAYER.TITLE',
    summaryKey: 'PROJECTS.MUSIC_PLAYER.SUMMARY',
    categoryKey: 'CATEGORIES.UTILITIES',
    tags: ['Angular', 'TypeScript', 'Signals', 'LocalStorage'],
    status: 'ready',
    image: 'assets/project-covers/music-player.svg',
    route: '/admin/projects/music-player',
    updatedAt: '2026-07-13',
    createdAt: '2026-07-13',
    difficulty: 'intermediate',
    layout: 'wide',
    repositoryUrl: `${REPOSITORY_BASE_URL}/music-player`,
    demoUrl: null
  },
  {
    order: 270,
    id: 'photo-book',
    titleKey: 'PROJECTS.PHOTO_BOOK.TITLE',
    summaryKey: 'PROJECTS.PHOTO_BOOK.SUMMARY',
    categoryKey: 'CATEGORIES.UTILITIES',
    tags: ['Angular', 'TypeScript', 'Signals', 'Gallery'],
    status: 'ready',
    image: 'assets/project-covers/photo-book.svg',
    route: '/admin/projects/photo-book',
    updatedAt: '2026-07-13',
    createdAt: '2026-07-13',
    difficulty: 'intermediate',
    layout: 'wide',
